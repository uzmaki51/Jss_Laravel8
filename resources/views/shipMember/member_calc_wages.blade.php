        ...
        function initTable() {
            listTable = $('#table-shipmember-list').DataTable({
                ...
                createdRow: function (row, data, index) {
                    ...
                    $('td', row).eq(4).html('<input type="text" class="form-control style-noncolor-input" name="Salary[]" value="' + data['Salary'] + '" style="width: 100%;text-align: center" autocomplete="off">');
                    ...
                    $('td', row).eq(8).html('<input type="text" class="form-control style-noncolor-input add-minus" name="MinusCash[]" value="' + data['MinusCash'] + '" style="width: 100%;text-align: center" autocomplete="off">');
                    ...
                    $('td', row).eq(11).html('<div class="input-group"><input class="form-control style-noncolor-input add-trans-date date-picker" name="TransDate[]" type="text" data-date-format="yyyy-mm-dd" value="' + data['TransDate'] + '"><span class="input-group-addon"><i class="icon-calendar "></i></span></div>');
                    $('td', row).eq(12).html('<input type="text" class="form-control style-noncolor-input" name="Remark[]" value="' + data['Remark'] + '" style="width: 100%;text-align: center" autocomplete="off">');
